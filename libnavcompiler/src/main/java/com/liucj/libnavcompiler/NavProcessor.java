package com.liucj.libnavcompiler;
...
@SupportedAnnotationTypes({"com.liucj.libnavannotation.ActivityDestination", "com.liucj.libnavannotation.FragmentDestination"})
