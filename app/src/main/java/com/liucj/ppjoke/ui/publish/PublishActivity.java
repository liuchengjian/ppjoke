package com.liucj.ppjoke.ui.publish;
...
import com.liucj.libnavannotation.ActivityDestination;
...
import com.liucj.ppjoke.ui.activity.PreviewActivity;
...
public class PublishActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private MaterialButton actionPublish;
    private MaterialButton actionAddTag;
    private EditText inputView;
    private AppCompatImageView actionAddFile;
    private AppCompatImageView actionDeleteFile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionPublish = findViewById(R.id.action_publish);
        actionAddTag = findViewById(R.id.action_add_tag);
        actionDeleteFile = findViewById(R.id.action_delete_file);
        actionAddFile = findViewById(R.id.action_add_file);
        ...
        actionPublish.setOnClickListener(this);
        actionDeleteFile.setOnClickListener(this);
        actionAddTag.setOnClickListener(this);
        actionAddFile.setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            ...
            case R.id.action_add_tag:
                ...
                fragment.setOnTagItemSelectedListener(new TagBottomSheetDialogFragment.OnTagItemSelectedListener() {
                    ...
                    public void onTagItemSelected(TagList tagList) {
                        mTagList = tagList;
                        actionAddTag.setText(tagList.title);
                    }
                });
            ...
            case R.id.action_delete_file:
                actionAddFile.setVisibility(View.VISIBLE);
    ...
    private void enqueue(List<OneTimeWorkRequest> workRequests) {
        ...
        workContinuation.getWorkInfosLiveData().observe(PublishActivity.this, new Observer<List<WorkInfo>>() {
            ...
            public void onChanged(List<WorkInfo> workInfos) {
                //每个人都会经历这些状态：block runing enuqued failed susscess finish
...
//                .keepResultsForAtLeast(10, TimeUnit.SECONDS)
    ...
    private void showFileThumbnail() {
        ...
        actionAddFile.setVisibility(View.GONE);
        fileContainer.setVisibility(View.VISIBLE);
        cover.setImageUrl(filePath);
