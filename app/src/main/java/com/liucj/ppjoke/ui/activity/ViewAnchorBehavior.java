...
public class ViewAnchorBehavior extends CoordinatorLayout.Behavior<View> {
    ...
    @Override
    public boolean onMeasureChild(@NonNull @NotNull CoordinatorLayout parent,
                                  @NonNull @NotNull View child,
    ...
    @Override
    public boolean onLayoutChild(@NonNull @NotNull CoordinatorLayout parent,
                                 @NonNull @NotNull View child,
                                 int layoutDirection) {
        View anchorView = parent.findViewById(anchorId);
        if (anchorView == null) {
