...
import com.liucj.ppjoke.ui.view.RecordView;
...
public class CaptureActivity extends AppCompatActivity implements RecordView.onRecordListener {
    ...
    private CameraX.LensFacing mLensFacing = CameraX.LensFacing.BACK;//默认后置相机
    ...
    public void onClick() {
        ...
        captureTips.setVisibility(View.INVISIBLE);
